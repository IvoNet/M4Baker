...
class AudiobookMetaDataPanel(wx.Panel):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.cover_art.SetToolTip("Drag and drop Cover Art here. Double click to reset.")
        ...
        ee.on("audiobook.new", self.ee_reset_metadata)
        ...
        self.cover_art_clean = True

    def ee_reset_metadata(self):
    ...
    def on_year(self, event):
        ...
        ee.emit("audiobook.year", event.GetString())
        event.Skip()
    ...
    def on_comment(self, event):
        ...
        ee.emit("audiobook.comment", event.GetString())
        event.Skip()
